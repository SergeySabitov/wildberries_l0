    ...
    <div class="cart_item_info right">
        <div class="controls_container ${disabled_item ? 'disabled' : ''}">
            ...
            <div class="controls_icons">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" class="likeIcon">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" class="deleteIcon">
        ...
        <div class="prices_container desktop_only ${disabled_item ? 'hide' : ''}">
            <div class="current_price_container">
                <span class="current_price ${String(item.price.after).length > 5 ? 'bigPrice' : ''}" id="${item.id}_price">${item.price.after * quantity}</span><span class="currency">сом</span>
            </div>
            ${item.price.before ? `<span class="before_price tooltip_container" id="${item.id}_priceWithoutDiscount">
                <span class="tooltip_trigger">${item.price.before * quantity} сом</span>
